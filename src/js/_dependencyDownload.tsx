...
function DependencyDownload() {
    ...
    let versionsRef = React.createRef<StateManager<{ value: string; label: string; }, false, GroupTypeBase<{ value: string; label: string; }>, Select<{ value: string; label: string; }, false, GroupTypeBase<{ value: string; label: string; }>>>>();
