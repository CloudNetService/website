  ...
  return (
    <Layout
      ...
      <main className={clsx('container', styles.legalText)}>
        ...
        <p>Joschua Kreimer<br/>
          c/o nexserv GmbH<br/>
          Dießemer Bruch 112c<br/>
          47805 Krefeld<br/>
          Deutschland</p>

        <h2>Kontakt</h2>
        <p>Telefon: +4915678578650<br/>
          E-Mail: <a href="mailto:contact@cloudnetservice.eu">contact@cloudnetservice.eu</a></p>
        ...
        <p><a href="https://twitter.com/CloudNetService" target="_blank">https://twitter.com/CloudNetService</a></p>

        <h3>Haftung für Links</h3> <p>Unser Angebot enthält Links zu externen Websites Dritter, auf deren Inhalte wir
        keinen Einfluss haben. Deshalb kö;nnen wir für diese fremden Inhalte auch keine Gewähr übernehmen.
