...
const features: FeatureProps[] = [
  ...
  },
  {
    ...
    icon: "trending_up",
    description: (
      <Translate id="homepage.feature.scalable.description">
        CloudNet is horizontally and vertically scalable. This means you can
        distribute your players across different virtual or dedicated servers to
            ...
            <div className={clsx("col", "col--8", styles.heroText)}>
              ...
              <div className={styles.buttons}>
                <Link
                  ...
                  to={useBaseUrl("docs/3.4/")}
                >
                  <Translate id="homepage.getStartedButton">
                    Get Started
                  </Translate>
                </Link>
              </div>
