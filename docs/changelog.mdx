...
<TabItem value="added">
  ...
  - Added [Tuinity](https://github.com/Tuinity/Tuinity) to the template installer
...
<TabItem value="api">
  ...
  - Added some ``PlayerExecutor#connect`` methods to connect the player on a fallback, a specific group, specific task using
  a ``ServerSelectorType``
  - Added an ``AdventureComponentMessenger`` to support the adventure text 4 API & deprecated the old
  ``VelocityComponentMessenger``
  - Added API access to the ``CloudServiceFactories``
  - Moved the NameTags from the CloudPerms-Module to the SimpleNameTags plugin and deprecated it in the
  CloudPerms-Module
...
## v3.3.0 - 2020-05-16 {#v330---2020-05-16}
...
<TabItem value="api">
  ...
  **Please adjust your plugins and modules, deprecated methods will be removed in a future release.**
  ...
  `CloudNetDriver#getServicesRegistry`. See the cloudnet-examples module for help.
  ...
  - Deprecated player methods in IPlayerManager, should now be accessed via `IPlayerManager#getPlayerExecutor` and
  `ICloudPlayer#getPlayerExecutor`
...
## v3.2.2 - 2020-01-16 {#v322---2020-01-16}
...
## v3.2.1 - 2019-12-29 {#v321---2019-12-29}
...
<TabItem value="fixed">
  ...
  - Fixed an issue that the smart module checked for all services (prepared, starting, ...) for the auto stop, which
  caused problems when using the preparedServices entry in the smart config
...
## v3.2.0 - 2019-12-25 {#v320---2019-12-25}
...
## v3.1.0 - 2019-11-02 {#v310---2019-11-02}
...
## v3.0.0 - 2019-05-21 {#v300---2019-05-21}
...
## v3.0.0 PRE-3 - 2019-03-10 {#v300-pre-3---2019-03-10}
...
## v3.0.0 PRE-2 - 2019-02-10 {#v300-pre-2---2019-02-10}
...
## v3.0.0 PRE-1 - 2019-02-03 {#v300-pre-1---2019-02-03}
...
<TabItem value="added">
  ...
  - Added a Permissions-System module, which supports the following PluginAPIs: => Bukkit, Velocity, ProxProx, GoMint,
  Nukkit, BungeeCord
...
## v3.0.0 BETA - 2018-12-08 {#v300-beta---2018-12-08}
...
<TabItem value="changed">
  ...
  - CloudNet 3 is a completely new cloud system with a completely new concept and new technical approaches --that bring
  many new possibilities.
  - It is a BETA version where the TODO is still very large, but to arouse the interest for this software at all and to
  show what the program can do so far.
